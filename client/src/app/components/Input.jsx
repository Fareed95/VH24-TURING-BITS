...
const user_email =contextemail;
  const placeholders = [
    "Is it effective for my exam preparation?",
"Does it contain any confusing or misleading information?",
"Does it provide all the essential concepts?",
"Are there any potential distractions?",
"Is it compatible with other study materials?",
  ];
